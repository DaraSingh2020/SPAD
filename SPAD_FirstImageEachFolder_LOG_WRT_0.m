...
temporaryFolder=strcat(temporaryFolder_(1:10),'_WRT_0_Results');
...
for fileNumber=fileN_Start:fileN_End
    ...
    parfor folderNumber=folderN_Start:folderN_End
        imageName_0=strcat(rootDirectory,num2str(folderNumber),'\',imagePrefix,num2str(0),'.tiff');
        imageName_1=strcat(rootDirectory,num2str(folderNumber),'\',imagePrefix,num2str(imageNumber),'.tiff');
...
caxis([minValue maxValue]);
colorbar
imageTitle=strcat('Gated[0]-Gated[',num2str(imageNumber),'] Total:',num2str(fileQuantity),' images, window:[',num2str(windowSize_5by5),' ,',num2str(windowSize_5by5), '], New Filter');
title(imageTitle)
FigureName_=strcat(FigureName,'_',num2str(windowSize_5by5),'by',num2str(windowSize_5by5));
pngFigureName_NewFilter=strcat(FigureName_,'_NewFilter.png');
saveas(gcf,pngFigureName_NewFilter);
...
caxis([minValue maxValue]);
colorbar
imageTitle=strcat('Gated[0]-Gated[',num2str(imageNumber),'] Total:',num2str(fileQuantity),' images, window:[',num2str(windowSize_3by3),' ,',num2str(windowSize_3by3), '], New Filter');
title(imageTitle)
FigureName_=strcat(FigureName,'_',num2str(windowSize_3by3),'by',num2str(windowSize_3by3));
pngFigureName_NewFilter=strcat(FigureName_,'_NewFilter.png');
saveas(gcf,pngFigureName_NewFilter);
