...
temporaryFolder=strcat(temporaryFolder_(1:10),'_delta_',num2str(delta),'_Results');
...
for fileNumber=fileN_Start:fileN_End
    ...
    parfor folderNumber=folderN_Start:folderN_End
        imageName_0=strcat(rootDirectory,num2str(folderNumber),'\',imagePrefix,num2str(imageNumber),'.tiff');
        imageName_1=strcat(rootDirectory,num2str(folderNumber),'\',imagePrefix,num2str(imageNumber+delta),'.tiff');
...
caxis([minValue maxValue]);
colorbar
imageTitle=strcat('Gated[',num2str(imageNumber),']-Gated[',num2str(imageNumber+delta),'] Total:',num2str(fileQuantity),' images, window:[',num2str(windowSize_5by5),' ,',num2str(windowSize_5by5), '], New Filter');
title(imageTitle)
FigureName_=strcat(FigureName,'_',num2str(windowSize_5by5),'by',num2str(windowSize_5by5));
pngFigureName_NewFilter=strcat(FigureName_,'_NewFilter.png');
saveas(gcf,pngFigureName_NewFilter);
...
% Normalized with respect to mean
mean_3by3=mean(nFlow_3by3,'all');
nFlow_3by3=nFlow_3by3./mean_3by3;
...
caxis([minValue maxValue]);
colorbar
imageTitle=strcat('Gated[',num2str(imageNumber),']-Gated[',num2str(imageNumber+delta),'] Total:',num2str(fileQuantity),' images, window:[',num2str(windowSize_3by3),' ,',num2str(windowSize_3by3), '], New Filter');
title(imageTitle)
FigureName_=strcat(FigureName,'_',num2str(windowSize_3by3),'by',num2str(windowSize_3by3));
pngFigureName_NewFilter=strcat(FigureName_,'_NewFilter.png');
saveas(gcf,pngFigureName_NewFilter);
