...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
figure(2)
imagesc(normalizedFlow1)
TT1=strcat('T',num2str(kk),' :averaged over image number: ',num2str(kk),' of ',num2str(folderN2),' Phantom');
TT2=strcat('Image_',num2str(kk),'_Averaged',num2str(kk),'_Of_',num2str(folderN2),'_FoldersBL')
title(TT1)
colormap default
%caxis([0 2.0]);
colorbar
...
figure(3)
normalizedFlow_SB=abs(normalizedFlow1-normalizedFlow);
imagesc(normalizedFlow_SB)
TT1=strcat('[T',num2str(kk),'-T',num2str(jj), '] after reconstruction Phantom');
TT2=strcat('SubractingImage',num2str(kk),'FromImage',num2str(jj), 'AfterReconstruction_FolderBL')
title(TT1)
colormap default
%caxis([0 .05]);
colorbar
