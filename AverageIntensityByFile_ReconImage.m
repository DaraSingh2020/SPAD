...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
close all
rawSubImageMean=zeros(fileLength,1);
reconSubImageMean=zeros(fileLength,1);
...
for folderNumber=folderN1:folderN2
    ...
    for fileNumber=fileN1:fileN2
        ...
        f=fileNumber+1;
        rawSubImageMean(f)=mean2(rawSubImage);
        ...
        reconSubImageMean(f)=mean2(reconSubImage);
        
        if fileNumber==fileN1
            normalizedFlowSaved=normalizedFlow;
        end
...
titleText=strcat('Reconstructed <I> over of images in folder NO.:',num2str(folderN1));
title(titleText)
ylabel('Average Intensity')
xlabel('File Number')
figName='IntensitySubRectBoxImage1To80_Folder_1';
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
figure(3)
normalizedFlowSaved(yMin:yMax,xMin:xMax)=0;
imagesc(normalizedFlowSaved)
